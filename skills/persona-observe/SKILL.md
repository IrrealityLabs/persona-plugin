...
file/dir if needed). Format, nothing else:

```json
{"context": "<prior exchange or situation, or empty>", "question": "<what they responded to>", "answer": "<what they said>"}
```
...
- One persona per run.
- The format is exactly `{context, question, answer}` — no other fields.
